...
class UnknownVersionException extends StreamCorruptedException {
   ...
   public GingersnapHeader toHeader() {
      return new GingersnapHeader(HotRodOperation.ERROR, version, messageId, "", 0, (short) 1, 0, MediaType.MATCH_ALL, MediaType.MATCH_ALL, null);
   }
}
